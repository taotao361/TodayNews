        ...
        if (delta <= 0) {
            ...
            if comp.year == comp2.year {
                if comp.day == comp2.day {
                    ...
                    return "\(String(describing: comp2.month))-\(String(describing: comp2.day)) \(String(describing: comp2.hour)):\(String(describing: comp2.minute))"
                }
            } else {
                return "\(String(describing: comp2.year))-\(String(describing: comp2.month))-\(String(describing: comp2.day)) \(String(describing: comp2.hour)):\(String(describing: comp2.minute))"
            }
        }
    }
